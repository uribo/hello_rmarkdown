...
output: 
  ioslides_presentation:
    ...
    fig_height: 3.7
    fig_caption: true
    logo: https://github.com/uribo/jpmesh/blob/master/man/figures/logo.png?raw=true
---
...
## Convert mesh code to coordinate and vice versa {.smaller}
...
## Detect fine and neighborhood mesh codes {.smaller}
